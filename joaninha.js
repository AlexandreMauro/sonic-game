...
function Joaninha(context, imagem, imgExplosao) {
...
/*Devemos cronometrar o movimento do 'XXXX' aplicando no método 
...
'XXXX.velocidade' da página HTML.*/

Joaninha.prototype = {
   atualizar: function() {
      this.y += 
         this.velocidade * this.animacao.decorrido / 850;
